...
public class FileIO {
    public void writeData(Map<String, AddressBookSystem> addressBook) {
        File file = new File("D:\\java eclipse\\Day22AddressBookSystem\\src\\com\\bridgelabz");
        BufferedWriter bw = null;
        try {
            bw = new BufferedWriter(new FileWriter(file));

            for (Map.Entry<String, AddressBookSystem> entry : addressBook.entrySet()) {
